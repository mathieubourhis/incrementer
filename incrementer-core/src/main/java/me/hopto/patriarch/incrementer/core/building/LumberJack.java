...
public class LumberJack extends Building {
	...
	public void addFoodFormula() {
		formulas.put(ResourceType.Food, new FormulaWrapper(ResourceType.Food, 0.0d, 30.0d, new Formula() {
	...
	public void addWoodFormula() {
		formulas.put(ResourceType.Wood, new FormulaWrapper(ResourceType.Wood, 0.5d, 0.0d, new Formula() {
