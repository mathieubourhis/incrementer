...
public enum BuildingType {
	BerryPicker(ResourceType.Food), FisherMan(ResourceType.Food), WoodGatherer(
			ResourceType.Wood), LumberJack(ResourceType.Wood), MetalDigger(
			ResourceType.Metal), Miner(ResourceType.Metal), Inventor(
			ResourceType.Tool), BlackSmith(ResourceType.Tool);
